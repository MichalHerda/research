...
├── experiments/         # Exploratory scripts and hypothesis-specific studies
...
* **`experiments/`** – Focused exploratory studies, one-off investigations, and scripts built around validating specific market hypotheses.
